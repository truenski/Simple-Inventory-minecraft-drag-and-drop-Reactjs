...
export function BoxesGroup() {
	...
	const arrInventory: group = [
		...
		{ id: 1, itemID: gameItems.WOOD }, { id: 2, itemID: gameItems.COBBLESTONE }, { id: 3, itemID: gameItems.FLINT }, { id: 4, itemID: gameItems.IRON }, { id: 5, itemID: gameItems.COAL }, { id: 6, itemID: gameItems.REDSTONE }, { id: 7}, { id: 8 }, { id: 9 },
		{ id: 10 }, { id: 11 }, { id: 12 }, { id: 13 }, { id: 14 }, { id: 15 }, { id: 16 }, { id: 17 }, { id: 18 },
		{ id: 19 }, { id: 20 }, { id: 21 }, { id: 22 }, { id: 23 }, { id: 24 }, { id: 25 }, { id: 26 }, { id: 27 },
		{ id: 28, class: "select-group", itemID: gameItems.IRON_PICKAXE }, { id: 29, class: "select-group", itemID: gameItems.STONE_SWORD }, { id: 30, class: "select-group", itemID: gameItems.CHAINMAIL_HELMET }, { id: 31, class: "select-group", itemID: gameItems.CHAINMAIL_CHESTPLATE }, { id: 32, class: "select-group", itemID: gameItems.CHAINMAIL_BOOTS }, { id: 33, class: "select-group", itemID: gameItems.CHAINMAIL_LEGGINGS }, { id: 34, class: "select-group", itemID: gameItems.SHIELD }, { id: 35, class: "select-group" }, { id: 36, class: "select-group delete" }
	...
	const swapBoxes = (fromBox: any, toBox: any) => {
		...
		if(fromBox.id === 46 && inventoryBoxes[toIndex].itemID){return}
	   ...
	   if(toIndex == 0 || toIndex== 1 || toIndex == 2|| toIndex == 3 || toIndex == 4 || fromIndex == 0 || fromIndex== 1 || fromIndex == 2|| fromIndex == 3 || fromIndex == 4){checkRecipe(); }
	}
	...
	const checkRecipe = () => {
		...
		let itemObj = gameItems.recipes[key];
		  if(currRecipe === itemObj.recipe || currRecipe === itemObj.recipe[0] || currRecipe === itemObj.recipe[1]){result.itemID = itemObj.id} 
		}
	}
